...
Case of 
	: (Count parameters:C259=0)
		...
		If (Application version:C493<"1660")  // 16R6
	...
	Else 
		...
		$options.title:="work with collection functions?"
		
		$options.blog:="blog.4d.com"
		//$options.info:="Setup the info in the 00_Start Method"  //ex : "4D View Pro feature"
		
		$options.minimumVersion:="2000"  // 2020 means 20R2   2001 means 20.1 (do not use !)
